...
from app.components.pdf_loader import load_pdfs_from_directory, split_documents_into_chunks
...
def load_data_and_create_vector_store():
    ...
    try:
        ...
        error_msg = CustomException("Failed to load data and create vector store", e)
...
if __name__ == "__main__":
    try:
        ...
        error_msg = CustomException("An unexpected error occurred in main execution of data_loader :", e)
        logger.error(str(error_msg))
        raise error_msg